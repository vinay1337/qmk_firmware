...
[_QWERTY] = LAYOUT_planck_grid(
    ...
    KC_LCTL, KC_LCTL, KC_LGUI, KC_LALT, RAISE,   KC_SPC,  KC_SPC,  LOWER,   TD_CTRL, KC_RGUI, KC_RALT, NAVIG
),
...
[_LOWER] = LAYOUT_planck_grid(
    ...
    KC_TILD, KC_APP , KC_PSCR, XXXXXXX, KC_LBRC, KC_LPRN, KC_RPRN, KC_RBRC, KC_MINS, KC_TILD, KC_COLN, KC_BSLS,
    _______, KC_MUTE, XXXXXXX, XXXXXXX, KC_LCBR, KC_LABK, KC_RABK, KC_RCBR, XXXXXXX, XXXXXXX, KC_SLSH, XXXXXXX,
